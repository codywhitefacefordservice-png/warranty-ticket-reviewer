...
- WEAR IS NOT AUTOMATICALLY EXCLUDED. Under the bumper-to-bumper New Vehicle Limited Warranty, a component that fails or wears out PREMATURELY within the coverage period because of a defect in materials or workmanship IS covered - Ford pays these as premature/abnormal wear caused by a defect, and under bumper-to-bumper virtually every part is covered when the failure is a manufacturer defect. Only a short, specific set of TRUE maintenance / normal-wear items are actually excluded: brake pads/linings and other friction material worn by normal use, wiper blades/inserts, engine/cabin air and oil filters, fluids and lubricants, spark plugs and other scheduled-maintenance items, clutch friction discs worn by use, wheel alignment/balancing, and tires (covered by the tire manufacturer). For one of THOSE true maintenance items claimed as warranty, DO flag it. But for ANY OTHER component (steering, suspension, drivetrain, engine internals, electrical, etc.) do NOT flag "wear and tear," "normal wear," or "maintenance item" as a rejection just because the cause mentions wear - within the warranty period, premature wear of such a part is a legitimate warrantable defect. Do not assume normal wear on a non-maintenance part; assume a possible defect. If the write-up leans on plain "worn out" language for a covered component, do NOT put it in "risks"; instead, in "questions" only, prompt the writer to state that the wear was PREMATURE / ABNORMAL for the vehicle's age and mileage and attributable to a manufacturer defect (e.g. "note that the steering components wore out well before their expected service life, indicating a defect"), and carry that premature-defect framing into the rewrite so the claim reads the way Ford expects to see it.
...
// ---------------------------------------------------------------------------
const RUBRIC_VERSION = "2026-07-16.11";
